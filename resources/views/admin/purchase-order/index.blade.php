...
@section('right-menu')
  <li class="nav-item">
    <a class="btn plus-btn btn-primary mr-2" href="{{ url('/admin/purchase-order/create') }}" title="Baru"><i
        ...
        <div class="row">
          <div class="col d-flex justify-content-end">
            <div class="form-group form-inline">
              ...
              <input class="form-control" id="search" name="search" type="text" value="{{ $filter['search'] }}" autofocus placeholder="Cari pemasok">
            </div>
          </div>
        </div>
                      ...
                      <td class="text-center">
                        <div class="btn-group">
                          @if ($item->status != StockUpdate::STATUS_OPEN)
                            <a class="btn btn-default btn-sm" href="{{ url("/admin/purchase-order/detail/$item->id") }}"><i
                                class="fa fa-eye" title="View"></i></a>
                          @else
                            <a class="btn btn-default btn-sm" href="{{ url("/admin/purchase-order/edit/$item->id") }}"><i
                                class="fa fa-edit" title="Edit"></i></a>
                          @endif
                          <a class="btn btn-danger btn-sm" href="{{ url("/admin/stock-update/delete/$item->id?goto=" . url('admin/purchase-order')) }}"
